...
DATASET_CONFIG = {
    'AHU': {
        'train_path': PROJECT_ROOT / "dataset" / "RP_1312" / "tabular" / "train" / f"train_{num}.csv",
        'normal_label': 'F1',
    },
    'chiller': {
        'train_path': PROJECT_ROOT / "dataset" / "RP_1043" / "tabular" / "Train" / f"chiller_L1_Train_{num}.csv",
        'normal_label': 'normal',
    },
}

...
# 数据集路径设置
train_data_dir = r'.\diffusionU1(allSEM_r2)\Generate_10000_U1_0.0001_se2(resnet_block_groups=8)_Summer(10)_U1SEM\R'
test_data_dir = r'.\dataset\dataset(O10)\FAG_images_AHU_Summer_Test_10'
